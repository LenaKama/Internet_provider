...
/**
 * Class for all field in application.
 *
...
public class ParamName {
    ...
    public static final String US_SURNAME = "usSurname";
    public static final String US_PASSPORT = "usPassport";
    public static final String US_ROLE = "usRole";
